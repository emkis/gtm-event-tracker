 ...
 * @public
 */
export declare type SubtractEventProperties<OriginalProps, PropsToSubtract> = Omit<OriginalProps, keyof PropsToSubtract> & EventProperties;
/**
 * Functions responsible for triggering track events.
 * @public
 */
export declare type TrackModule<CustomEventProperties extends EventProperties> = {
    /**
